...
//NEW Instance class for use;
  ...
  ?>
    ...
    <form method="post" action="<?php echo e(url('ucontent')); ?>" enctype="multipart/form-data">
        ...
        <input type="hidden" name="nid" value="<?php echo e($new->nid); ?>">
        <input type="hidden" name="create_user" value="<?php echo e(Auth::user()->name); ?>">
        <input type="hidden" name="create_date" value="<?php date_default_timezone_set("Asia/Bangkok");
                echo date("Y-m-d H:i:s"); ?>">
    <!--    <div class="form-group">
        <label for="year">ปีการศึกษา:</label>
            <input type="text" class="form-control" id="year" name="year" value="<?php echo e($new->year); ?>" >
        </div> -->
        <div class="form-group">
