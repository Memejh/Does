...
<div class="main-content">
  ...
  ?>
    ...
    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('id','ไอดีสไลด์'));?></th>
        ...
        foreach($slide as $ss) {
          ...
          $link = '<a href="#" title="ที่อยู่ลิ้งค์" data-content="'.$ss->url.'"class="btn btn-info" data-toggle="popover" data-trigger="focus">Link</a>';
            echo '<tr>
                                ...
                                <td>' . $i++ . '</td>
                                <td><p >' . $ss->orders . '</p></td>
                                <td><button   class="btn disabled" style="border-radius: 0px; ">ไอดีสไลด์: '.$ss->id .'</button><br><img class="zoom" style="height:150px; width:250px; border: 3px solid #d9d9d9;   " src="' . asset("Slides/".$ss->img_name ). '"/></td>
                                <td>' . $link . '</td>
                                <td>'.$btn.'</td>
