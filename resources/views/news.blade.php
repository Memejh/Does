           ...
           <div class="container">
                <div class="row">
                        ...
                        <div class="tab-content">
                           ...
                           for($i=0;$i<count($t);$i++){
                              // $blog->h('2',$t[$i],'');
                               $news = DB::table('news')->where('cat', 34)->where('year', $t[$i])->orderBy('year','desc')->get();
                               $blog->ul('');
                        ...
                        <?php 
                           ...
                           for($i=0;$i<count($t);$i++){
                              // $blog->h('2',$t[$i],'');
                               $news = DB::table('news')->where('cat', 35)->where('year', $t[$i])->orderBy('year','desc')->get();
                               $blog->ul('');
                               foreach ($news as $newsOut) {
                                 $link="";
                                 if($newsOut->url !=""){$link =$newsOut->url;}
                       ...
                       for($i=0;$i<count($t);$i++){
                         //  $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 41)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
                       ...
                       for($i=0;$i<count($t);$i++){
                          // $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 42)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
                      ...
                      $blog->tabsPaneOff();
                       ...
                       for($i=0;$i<count($t);$i++){
                         //  $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 36)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
                       ...
                       for($i=0;$i<count($t);$i++){
                           $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 37)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
                       ...
                       for($i=0;$i<count($t);$i++){
                          // $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 38)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
                       ...
                       $blog->tabsPaneOff();
                        ...
                        <?php 
                        $blog->tabsPaneOn("tab8","");
                        $t= $db->getYears("news","year");
                        $blog->divOn("timeline","margin-left:10%;");
                       for($i=0;$i<count($t);$i++){
                         //  $blog->h('2',$t[$i],'');
                           $news = DB::table('news')->where('cat', 47)->where('year', $t[$i])->orderBy('year','desc')->get();
                           $blog->ul('');
                           foreach ($news as $newsOut) {
                             $link="";
                             if($newsOut->url !=""){$link =$newsOut->url;}
