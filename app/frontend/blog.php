...
class blog{
    ...
    function blogOn($classCss,$overray,$container){
        ...
        if($container == "onF"){ $this->switchContainer = "container-fluid";}
         else if($container == "on"){ $this->switchContainer = "container";}
            else{$this->switchContainer = '';}   
        ...
        if( $this->switchContainer != ''){echo '<div class="'.$this->switchContainer.'">
            <div class="row">';}
    }

    function blogOff(){
        if( $this->switchContainer != ''){echo '</div></div>';}
        echo ' </section >';
    }
    ...
    function tabsPaneBody($url,$h1,$h2){echo '
        <div class="col-sm-3">
            <div class="thumbnail">
    ...
    function h($h,$text,$style){echo '<h'.$h.' style="'.$style.'">'.$text.'</h'.$h.'>';}


    function ul($style){echo '<ul style="'.$style.'">';}
    function eul(){echo '</ul>';}
